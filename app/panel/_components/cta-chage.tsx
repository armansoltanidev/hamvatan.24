...
export default function CtaCharge({ children }: { children: string }) {
  return (
    <div className="group flex-1 flex flex-col justify-center cursor-pointer h-32 text-center hover:bg-[#fffcf5] border rounded-lg hover:border-[#fabe32] transition-colors ease-in-out duration-300">
