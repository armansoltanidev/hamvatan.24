...
export default function HeroSection() {
  return (
    <main className="mt-8 grid h-auto w-full grid-cols-6 rounded-3xl bg-primary px-6 py-4">
      <div className="col-span-2 hidden md:block"></div>
      <div className="col-span-6 px-3 py-16 md:col-span-4 md:px-6">
        <h1 className="text-gradient-slate py-6 text-5xl font-extrabold md:text-7xl md:leading-snug ">
        ...
        <section className="mt-12 flex flex-col items-center justify-between gap-y-6 md:flex-row">
          ...
          <div>
            <TypographyP className="text-base text-muted-foreground">
              مورد اعتماد بیش از
            </TypographyP>
